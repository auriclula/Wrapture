...
static const OptionDef *options2;

/* FFprobe context */
static const char *input_filename2;
...
static void opt_input_file2(void *optctx, const char *arg)
{
 /* //ME   if (input_filename2) {
        av_log(NULL, AV_LOG_ERROR,
...
int ffprobe(int argc, char **argv)
{
    ...
    options2 = real_options;
    parse_loglevel(argc, argv, options2);
    ...
    show_banner(argc, argv, options2);
    parse_options(NULL, argc, argv, options2, opt_input_file2);
    ...
    if ((ret = writer_open(&wctx, w, w_args,
        ...
        if (!input_filename2 &&
            ...
            ret = AVERROR(EINVAL);
        } else if (input_filename2) {
            ret = probe_file(wctx, input_filename2);
